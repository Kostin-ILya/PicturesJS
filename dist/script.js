...
/* harmony import */ var _services_dragFile__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/dragFile */ "./src/js/services/dragFile.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.wow.init();
  var order = {};
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_2__["modals"])('show', 600000);
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_3__["default"])('.main-slider-item', '', '', 'vertical', 800000);
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])(order);
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', order);
...
var accordion = function accordion(triggerSelector, contentSelector) {
  var headers = document.querySelectorAll(triggerSelector);
  var blocks = document.querySelectorAll(contentSelector);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(sizeSelector, materialSelector, optionsSelector, promocodeSelector, resultSelector, order) {
  ...
  function calcPrice() {
    ...
    if (!size.value || !material.value) {
      ...
      result.textContent = "".concat(Math.round(sum * 0.7), "\u0440\u0443\u0431.");
...
/* harmony import */ var _services_checkInputs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/checkInputs */ "./src/js/services/checkInputs.js");
...
var forms = function forms(order) {
  function bindForm(formSelector) {
    ...
    uploadInputs.forEach(function (item) {
      item.addEventListener('input', function () {
        ...
        var dots = fileNameArr[0].length > 10 ? '...' : '.';
        var name = fileNameArr[0].slice(0, 10) + dots + fileNameArr[1];
    ...
    forms.forEach(function (item) {
      item.addEventListener('submit', function (e) {
        ...
        var api = item.closest('[data-design') ? path.design : path.callBack;
        ...
        if (item.matches('[data-design]')) {
          ...
          item.querySelector('input').files.forEach(function (file) {
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_8__["postData"])(api, formData).then(function (data) {
          ...
          setTimeout(function () {
            Object(_modals__WEBPACK_IMPORTED_MODULE_9__["closeAllModal"])('[data-modal]', 'show');
            statusBlock.remove();
  ...
  bindForm('form');
  Object(_services_checkInputs__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="message"]');
  Object(_services_checkInputs__WEBPACK_IMPORTED_MODULE_10__["default"])('[name="name"]');
};
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: modals, closeAllModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modals = function modals(activeClass, showModalTimer) {
  ...
  function openModalByScroll() {
    if (!triggerPressed && window.scrollY + document.documentElement.clientHeight >= Math.max(document.documentElement.offsetHeight, document.body.offsetHeight) - 5) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.classList.add('overflow');
        document.body.style.marginRight = "".concat(calcScroll(), "px"); // Для того чтобы не прыгала страница

        document.querySelector('.fixed-gift').style.right = "".concat(calcScroll() + 20, "px");
...
var picturesSize = function picturesSize(selector) {
  var blocks = document.querySelectorAll(selector);

  function showImg(block) {
    var img = block.querySelector('img');
    var text = block.querySelectorAll('p:not(.sizes-hit)');
  ...
  function hideImg(block) {
    var img = block.querySelector('img');
    var text = block.querySelectorAll('p');
...
var showMoreCards = function showMoreCards(trigger, wrapperSelector) {
  ...
  btn.addEventListener('click', function (event) {
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["getResources"])('assets/db.json').then(function (data) {
...
var sliders = function sliders(slidesSelector, next, prev, direction, interval) {
  var slideIndex = 0;
  var timerIntervalId;
...
var tabs = function tabs() {
  var tabWrapper = document.querySelector('.portfolio-menu');
  var contentWrapper = document.querySelector('.portfolio-wrapper');
  var liItems = tabWrapper.querySelectorAll('li');
  var allContent = contentWrapper.querySelectorAll('.all');
  var noContentText = document.querySelector('.portfolio-no');

  function showContent(selectedContentSelector) {
    var content = contentWrapper.querySelectorAll(selectedContentSelector);
  ...
  function bindAction(selector) {
    var tab = tabWrapper.querySelector(selector);
...
/***/ "./src/js/services/checkInputs.js":
/*!****************************************!*\
  !*** ./src/js/services/checkInputs.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _requests__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./requests */ "./src/js/services/requests.js");
...
var dragFile = function dragFile(inputSelector) {
  ...
  inputs.forEach(function (item) {
    item.addEventListener('drop', function (e) {
      ...
      item.files.forEach(function (file) {
        ...
        var dots = fileNameArr[0].length > 10 ? '...' : '.';
        var name = "".concat(fileNameArr[0].slice(0, 10) + dots + fileNameArr[1], "\b\b");
        text += name;
      ...
      if (item.closest('main')) {
        ...
        Object(_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])('assets/server.php', formData).then(function (res) {
          console.log(res);
        }).catch(function (err) {
          console.log(err);
        }).finally(function () {
